-- Simple 2FA Fix - Run this in your Supabase SQL Editor
...
-- Step 3: Create generate_2fa_code function
...
BEGIN
    ...
    -- For testing, allow 2FA even if not enabled
...
-- Step 4: Create verify_2fa_code function

-- Bulk 2FA System - Simplified Version (No HTML Email)
...
BEGIN
    ...
    RAISE NOTICE '2FA code % would be sent to % for user %', available_code.code, user_record.email, user_record.full_name;
    ...
    result := json_build_object(
        ...
        'account_id', account_id,
        'code', available_code.code,  -- Include code for testing purposes
...
-- Step 12: Add two_factor_enabled column to profiles if it doesn't exist
DO $$
BEGIN
    IF NOT EXISTS (
